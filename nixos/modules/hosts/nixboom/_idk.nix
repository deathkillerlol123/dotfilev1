...
in
{
  ...
  home.file = {
    ...
    ".config/walrus" = {source = "${dotfiles}/.config/walrus"; recursive = true;};
    ".config/wallust" = {source = "${dotfiles}/.config/wallust"; recursive = true;};
    ".config/swaync" = {source = "${dotfiles}/.config/swaync"; recursive = true;};
    ".config/swaylock" = {source = "${dotfiles}/.config/swaylock";};
    ".config/rofi" = {source = "${dotfiles}/.config/rofi"; recursive = true;};
    ".config/nvim" = {source = "${dotfiles}/.config/nvim"; recursive = true;};
    ".config/niri" = {source = "${dotfiles}/.config/niri"; recursive = true;};
    ".config/fastfetch" = {source = "${dotfiles}/.config/fastfetch";};
    ".config/mango" = {source = "${dotfiles}/.config/mango";};
    ".config/mako" = {source = "${dotfiles}/.config/mako"; recursive = true;};
    ".config/eww" = {source = "${dotfiles}/.config/eww"; recursive = true;};
    ...
    ".config/qutebrowser" = {source = "${dotfiles}/.config/qutebrowser"; recursive = true;};
