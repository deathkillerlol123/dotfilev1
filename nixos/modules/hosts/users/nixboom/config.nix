{ self, ... }: {
  flake.nixosModules.nixboom = {lib,pkgs,inputs,...}:
    ...
    in
    {
      imports = fmod [ "lime" "dragware" "gaming" "main" ] ++
      ...
      environment.systemPackages = with pkgs; [
        ghostty wdisplays whatsapp-electron firefox #libreoffice
        awww waypaper pywal swaylock rofi bzmenu pwmenu
        copyq grim slurp swappy wl-clipboard
      ];
