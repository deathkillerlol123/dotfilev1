...
hl.bind(mainMod .. " + O", hl.dsp.exec_cmd("~/dotfiles/nixos/modules/hosts/users/nixboom/home/scripts/clean_exit.sh"))
...
hl.bind(mainMod .. " + SHIFT + S", hl.dsp.window.swap({ direction = "d" }))
